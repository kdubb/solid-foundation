...
public struct SystemInstantSource: InstantSource {
  ...
  /// ``InstantSource/system`` is accessed.
  ///
  @TaskLocal
  ...
  /// when ``instance`` or  ``InstantSource/system`` is
  /// accessed.
  ///
  ...
  /// ``InstantSource/system``. It is much preferred to use
...
extension InstantSource where Self == SystemInstantSource {

  public static var system: InstantSource {
