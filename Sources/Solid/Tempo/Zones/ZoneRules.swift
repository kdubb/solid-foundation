...
extension Tempo {
  ...
  /// as being a ``Swift/Collection`` of ``Tempo/ZoneOffset``
  /// values.
  ///
  ...
  public protocol ZoneRules: AnyObject, Sendable {
    ...
    /// Returns the standard offset for the specified ``Tempo/Instant``.
    ///
...
extension Tempo.ValidZoneOffsets: Sendable {}
extension Tempo.ValidZoneOffsets: Equatable {}
extension Tempo.ValidZoneOffsets: Hashable {}

extension Tempo.ValidZoneOffsets: Collection {

  public typealias Element = Tempo.ZoneOffset
  ...
  public subscript(index: Int) -> Tempo.ZoneOffset {
    switch self {
    case .skipped:
