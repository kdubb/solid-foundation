...
extension Tempo {
  ...
  ///
  /// The major purpose of a ``Temp/CalendarSystem`` is to convert between
  /// ``Tempo/Instant`` values and ``Tempo/DateTime`` values (e.g.,
  /// ``Tempo/ZonedDateTime`` and ``OffsetDateTime``) as well as to provide
...
extension Tempo.CalendarSystem {
  ...
  public func components<C>(
    from instant: Tempo.Instant,
    in zone: Tempo.Zone
  ) -> C where C: Tempo.ComponentBuildable {
