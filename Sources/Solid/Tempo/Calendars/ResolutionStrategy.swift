...
public struct ResolutionStrategy {
  ...
  /// ``ResolutionStrategy`` instance, functions that require a
  /// resolution strategy accept a set of ``ResolutionStrategy/Option``
...
extension ResolutionStrategy: Equatable {}
extension ResolutionStrategy: Hashable {}
extension ResolutionStrategy: Sendable {}

extension ResolutionStrategy.SkippedLocalTime.BoundaryEdge: Equatable {}
extension ResolutionStrategy.SkippedLocalTime.BoundaryEdge: Hashable {}
extension ResolutionStrategy.SkippedLocalTime.BoundaryEdge: Sendable {}

extension ResolutionStrategy.SkippedLocalTime: Equatable {}
extension ResolutionStrategy.SkippedLocalTime: Hashable {}
extension ResolutionStrategy.SkippedLocalTime: Sendable {}

extension ResolutionStrategy.AmbiguousLocalTime: Equatable {}
extension ResolutionStrategy.AmbiguousLocalTime: Hashable {}
extension ResolutionStrategy.AmbiguousLocalTime: Sendable {}

extension ResolutionStrategy.Option: Equatable {}
extension ResolutionStrategy.Option: Hashable {}
extension ResolutionStrategy.Option: Sendable {}

extension ResolutionStrategy.Options {

  public static let strict: Self = [.skipped(.reject), .ambiguous(.reject)]

  public var strategy: ResolutionStrategy {
    ResolutionStrategy(options: self)
  }
