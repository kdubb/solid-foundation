...
///
/// - Note: Tempo uses the ``GregorianSystem/Variant/iso8601``
...
public struct GregorianCalendarSystem: CalendarSystem, Sendable {
  ...
  internal func compute<C, S>(
    _ component: C,
    from components: S,
  ) -> C.Value where C: DateTimeComponent, C.Value == Int, S: ComponentContainer {
    switch component.id {
  ...
  internal func compute<C, S>(
    _ component: C,
    from components: S,
  ) -> C.Value where C: DateTimeComponent, C.Value == Int128, S: ComponentContainer {
    switch component.id {
