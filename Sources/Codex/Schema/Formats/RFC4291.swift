...
public enum RFC4291 {
  ...
  public struct IPv6Address {
    ...
    public static func parse(string: String) -> IPv6Address? {
      ...
      var ipv4Embedded: RFC2673.IPv4Address? = nil
      ...
      if string.contains(".") {
        ...
        guard let ipv4 = RFC2673.IPv4Address.parse(string: ipv4String) else {
          return nil
        }
      ...
      if let ipv4 = ipv4Embedded {
        ...
        groupsStr.append(String(format: "%x", group1))
        groupsStr.append(String(format: "%x", group2))
      }
