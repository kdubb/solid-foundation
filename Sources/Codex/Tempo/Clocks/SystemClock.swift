...
extension Tempo {
  ...
  /// A clock that provides the current time using the ``Tempo/SystemInstantSource``.
  ///
...
extension Tempo.Clock where Self == Tempo.SystemClock {

  /// The system clock that provides the current time in UTC.
  ///
  public static var system: Self {
    return Tempo.SystemClock.utc
  }
