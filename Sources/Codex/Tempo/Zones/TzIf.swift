...
extension Tempo.TzIf {
  ...
  private static func parsePOSTXFooter(
    from data: inout ReadableRawBuffer<BigEndian>,
    allowExtended: Bool,
  ) throws -> PosixTZ? {
...
extension Tempo.TzIf.V2 {
  ...
  fileprivate static func parse(
    ...
    guard let posixTZ = try Tempo.TzIf.parsePOSTXFooter(from: &data, allowExtended: false) else {
      // No footer found
      return rules
    }
...
extension Tempo.TzIf.V3 {
  ...
  fileprivate static func parse(
    ...
    rules.posixTZ = try Tempo.TzIf.parsePOSTXFooter(from: &data, allowExtended: true)
