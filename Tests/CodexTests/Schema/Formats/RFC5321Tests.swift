...
@Suite("RFC5321 Mailbox Tests")
final class RFC5321Tests {

  @Test("Valid Mailbox Parsing", arguments: [
    ...
    "user@" + "a".padding(toLength: 63, withPad: "a", startingAt: 0) + "." + "b".padding(toLength: 63, withPad: "b", startingAt: 0) + "." + "c".padding(toLength: 63, withPad: "c", startingAt: 0) + "." + "d".padding(toLength: 59, withPad: "d", startingAt: 0) + ".com"
  ])
  ...
  @Test("Invalid Mailbox Parsing", arguments: [
    // Missing @
    "userexample.com",
    // Missing local part
    "@example.com",
    ...
    "user@" + "a".padding(toLength: 63, withPad: "a", startingAt: 0) + "." + "b".padding(toLength: 63, withPad: "b", startingAt: 0) + "." + "c".padding(toLength: 63, withPad: "c", startingAt: 0) + "." + "d".padding(toLength: 63, withPad: "d", startingAt: 0) + ".bad.com",
  ...
  @Test("Mailbox Properties", arguments: [
