...
struct RFC3339Tests {
  ...
  struct FullDateTests {
    ...
    @Test("Invalid full-date parsing",
          arguments: [
  ...
  struct FullTimeTests {
    ...
    @Test("Invalid full-time parsing",
          arguments: [
            ...
            ("23:59:59+15:00", Comment("Invalid timezone offset")),
            ("23:59:59-15:00", Comment("Invalid timezone offset")),
  ...
  struct DateTimeTests {
    ...
    @Test("Invalid date-time parsing",
          arguments: [
